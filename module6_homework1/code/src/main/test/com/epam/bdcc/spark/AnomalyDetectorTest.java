...
//        List<List<>> inputMonitoringRecords = Arrays.asList(Arrays.asList("key"), Arrays.asList(monitoringRecord), Arrays.asList(inputHTM));
//        List<List<MonitoringRecord>> outputMonitoringRecords = Arrays.asList(Arrays.asList(monitoringRecord));
//
//
//        testOperation(inputMonitoringRecords, mappingFunc, outputMonitoringRecords);
